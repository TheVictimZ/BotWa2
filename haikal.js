...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/ee16068a099108eb646c2.jpg',"thumbnail": thumb,"sourceUrl": `https://wa.me/6283181666350?text=REYZ+ANTI+JOMOK+URAA+HORMAT+KEPADA+REYZ👿🤩😹☠️👾🔥`}}}, { quoted:m})} 
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yoapk Joki Abu WA*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yozip Joki Abu WA*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf Joki Abu WA*')
}
